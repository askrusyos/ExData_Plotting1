...
# Creation of the grid that will contain the four plots.
png(filename = "plot4.png", width = 480, height = 480)
par(mfrow=c(2,2))

# Top-left plot
plot(dataset_feb$newDate, dataset_feb$Global_active_power, xlab = "", ylab = "Global Active Power", type ="n")
lines(dataset_feb$newDate, dataset_feb$Global_active_power, type="l")

# Top-right plot
plot(dataset_feb$newDate, dataset_feb$Voltage, xlab = "datetime", ylab = "Voltage", type ="n")
lines(dataset_feb$newDate, dataset_feb$Voltage, type="l")
...
# Bottom-right plot
plot(dataset_feb$newDate, dataset_feb$Global_reactive_power, xlab = "datetime", ylab = "Global_reactive_power", type ="n")
lines(dataset_feb$newDate, dataset_feb$Global_reactive_power, type="l", lwd=0.1)
